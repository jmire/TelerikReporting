...
Partial Class ProductLineSales
    ...
    "tCategory"
        ...
        Me.textBoxReportFooter.Value = "AdventureWorks {today().Year}"
        '
        'ProductLineSales
        '
        Me.Culture = New System.Globalization.CultureInfo("en-US")
        Me.DocumentName = "= Parameters.ProductCategory.Value + 'Sales(' + Join("", "", Parameters.ProductSubc" &
    "ategory.Value) + ')[' + today().ToString('MMMM yyyy') + ']'"
